...
use cosmwasm_std::{
    from_binary, from_slice, to_binary, to_vec, Addr, Binary, CosmosMsg, Deps, DepsMut, Empty, Env,
    MessageInfo, Order, Reply, Response, StdError, StdResult, Storage, Uint128, WasmMsg,
};
...
//     match msg {
//         MigrateMsg::FromBeta {} => {
//             // Retrieve proposal IDs.
//             let keys: Vec<u64> = PROPOSALS
//                 .keys(deps.storage, None, None, Order::Ascending)
//                 .collect::<StdResult<Vec<u64>>>()?;

//             println!("count {}", keys.len());

//             let keys_raw = PROPOSALS
//                 .keys_raw(deps.storage, None, None, Order::Ascending)
//                 .collect::<Vec<Vec<u8>>>();

//             println!("count {}", keys_raw.len());

//             // Migrate each proposal.
//             keys_raw
//                 .into_iter()
//                 .try_for_each::<_, Result<(), StdError>>(|k| {
...
//                     //     String::from_utf8(k)?
//                     //         .parse::<u64>()
//                     //         .map_err(|_| StdError::ParseErr {
//                     //             target_type: "u64".to_string(),
//                     //             msg: "could not parse key into u64".to_string(),
//                     //         })?;
//                     // let path = PROPOSALS.key(key);
//                     // let v = deps
//                     //     .storage
//                     //     .get(&path)
//                     //     .ok_or_else(|| StdError::not_found("proposal"))?;
//                     // let beta_proposal: BetaProposal = from_slice(&v)?;
//                     // let new_proposal: SingleChoiceProposal = SingleChoiceProposal {
//                     //     title: beta_proposal.title,
//                     //     description: beta_proposal.description,
//                     //     proposer: beta_proposal.proposer,
//                     //     start_height: beta_proposal.start_height,
//                     //     min_voting_period: beta_proposal.min_voting_period,
//                     //     expiration: beta_proposal.expiration,
//                     //     threshold: beta_proposal.threshold,
//                     //     total_power: beta_proposal.total_power,
//                     //     msgs: beta_proposal.msgs,
//                     //     status: beta_proposal.status,
//                     //     votes: beta_proposal.votes,
//                     //     allow_revoting: beta_proposal.allow_revoting,
//                     //     deposit_info: beta_proposal.deposit_info,
//                     //     created: env.block.time,
//                     //     last_updated: env.block.time,
//                     // };
//                     // deps.storage.set(&path, &to_vec(&new_proposal)?);
//                     Ok(())
//                 })?;
